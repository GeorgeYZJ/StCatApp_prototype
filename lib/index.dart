              ...
              children: <Widget>[
                ...
                Container(
                  child: ListView(
                    ...
                    children: <Widget>[
                      _ProductCard(myImageUrl[0], "Notification",
                          "Things and Events You Should Know This Week"),
                      _ProductCard(myImageUrl[1], "Make more friends",
                          "Know More People In The College"),
                      _ProductCard(myImageUrl[2], "Let\' Study",
                          "Get To Know People Doing Same Units In The College"),
                      _ProductCard(myImageUrl[3], "St Cat\'s Event",
                          "Events Coming Up This Week"),
                      _ProductCard(myImageUrl[4], "Today\'s Menu",
